...
export class RoleMapper {
  ...
  toOrm(domainEntity: Role): RoleOrmEntity {
    ...
    ormEntity.permissionIds =
      domainEntity.permissionIds.length > 0
        ? [...domainEntity.permissionIds]
        : undefined
    ormEntity.userIds =
      domainEntity.userIds.length > 0 ? [...domainEntity.userIds] : undefined
    ...
    ormEntity.childRoleIds =
      domainEntity.childRoleIds.length > 0
        ? [...domainEntity.childRoleIds]
        : undefined
