...
describe('RoleNotificationService', () => {
  ...
  describe('notifyRoleStatusChanged', () => {
    it('应该发送角色状态变更通知', async () => {
      ...
      await service.notifyRoleStatusChanged(
        role,
        adminUserId,
        oldStatus,
        newStatus,
  ...
  describe('notifyPermissionAssignedToRole', () => {
    it('应该发送权限分配通知', async () => {
      ...
      await service.notifyPermissionAssignedToRole(
        role,
        permissionId,
        adminUserId,
      )
  ...
  describe('notifyPermissionRemovedFromRole', () => {
    it('应该发送权限移除通知', async () => {
      ...
      await service.notifyPermissionRemovedFromRole(
        role,
        permissionId,
        adminUserId,
      )
  ...
  describe('error handling', () => {
    it('应该在通知发送失败时正确处理错误', async () => {
      ...
      await expect(
        service.notifyRoleCreated(role, adminUserId),
