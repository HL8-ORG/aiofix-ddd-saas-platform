...
describe('UserDomainEvent', () => {
  ...
  describe('UserInfoUpdatedEvent', () => {
    it('应该正确创建用户信息更新事件', () => {
      ...
      const event = new UserInfoUpdatedEvent(mockUser, oldInfo, newInfo, updatedBy);
  ...
  describe('UserContactInfoUpdatedEvent', () => {
    it('应该正确创建用户联系信息更新事件', () => {
      ...
      const updatedBy = generateUuid();
      const event = new UserContactInfoUpdatedEvent(mockUser, oldContactInfo, newContactInfo, updatedBy);
  ...
  describe('UserLoginFailureEvent', () => {
    it('应该正确创建用户登录失败事件', () => {
      ...
      const event = new UserLoginFailureEvent(mockUser, ipAddress, userAgent, failureReason);
  ...
  describe('UserPreferencesUpdatedEvent', () => {
    it('应该正确创建用户偏好设置更新事件', () => {
      ...
      const updatedBy = generateUuid();
      const event = new UserPreferencesUpdatedEvent(mockUser, oldPreferences, newPreferences, updatedBy);
  ...
  describe('UserAssignedToOrganizationEvent', () => {
    it('应该正确创建用户分配到组织事件', () => {
      ...
      const event = new UserAssignedToOrganizationEvent(mockUser, organizationId, assignedBy);
  ...
  describe('UserRemovedFromOrganizationEvent', () => {
    it('应该正确创建用户从组织移除事件', () => {
      ...
      const event = new UserRemovedFromOrganizationEvent(mockUser, organizationId, removedBy);
  ...
  describe('Event Inheritance', () => {
    it('所有事件都应该继承自UserDomainEvent', () => {
      const events = [
        ...
        new UserInfoUpdatedEvent(mockUser, { firstName: 'Old', lastName: 'Name' }, { firstName: 'New', lastName: 'Name' }),
        new UserContactInfoUpdatedEvent(mockUser, { email: 'old@example.com' }, { email: 'new@example.com' }),
