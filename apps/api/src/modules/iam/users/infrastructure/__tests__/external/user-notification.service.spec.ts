...
import { UserNotificationService, NotificationPayload } from '../../external/user-notification.service';
...
describe('UserNotificationService', () => {
  ...
  describe('sendNotification', () => {
    ...
    it('当通知服务被禁用时应该跳过发送', async () => {
      ...
      const disabledService = disabledModule.get<UserNotificationService>(UserNotificationService);
